...
class Partido extends HiveObject {
  ...
  Partido({
    ...
    this.id =
        '${this.fecha.year.toString()}-${this.fecha.month.toString().padLeft(2, '0')}-${this.fecha.day.toString().padLeft(2, '0')}-${this.fecha.millisecond.toString()}-${this.liga}-${this.numCancha.toString()}'; //id tiene que arrancar en 0
