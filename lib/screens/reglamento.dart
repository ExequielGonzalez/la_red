      ...
      body: BackgroundTemplate(
        ...
        child: Container(
            ...
            child: ListView(
              ...
              children: [
                Text( " Al día de la fecha, las comunicaciones son una"
                    "parte fundamental de nuestras vidas, en este trabajo realzaremos"
                    "un breve resumen de las actuales tecnologías de telefonía "
                    "móvil  para luego investigar y documentar en que se basa la Tecnología 5G, las mejoras que propone y también realizar un resumen de las pruebas echas hasta el momento en Argentina.Además, uno de los beneficios que esta nueva tecnología nos promete es la de dar mayor soporte y confiabilidad al IoT (Internet of Things) por lo cual realizaremos también un apartado especial para dicho tema y como se vinculan "
